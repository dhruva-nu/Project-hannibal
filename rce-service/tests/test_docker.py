...
class TestGetClient:
    def test_creates_client_when_none(self, mocker):
        ...
        mock = MagicMock()
        mocker.patch("rce_service.docker.docker.from_env", return_value=mock)
    ...
    def test_returns_cached_client(self, mocker):
        ...
        patched = mocker.patch("rce_service.docker.docker.from_env")
...
class TestRCEEvents:
    def test_stdout_line_fields(self):
        from rce_service.events import StdoutLine
    ...
    def test_stderr_line_fields(self):
        from rce_service.events import StderrLine
    ...
    def test_exit_event_fields(self):
        from rce_service.events import ExitEvent
    ...
    def test_error_event_fields(self):
        from rce_service.events import ErrorEvent
...
class TestStreamCode:
    ...
    async def test_timeout_kill_failure_is_silenced_in_stream(self, mocker):
        ...
        mocker.patch("rce_service.docker.threading.Timer", _instant_timer)
