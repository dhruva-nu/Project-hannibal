...
from app.exception.rce_exception import DependencyInstallError
from app.services.rce.deps import DEPS_PROVIDERS
from app.services.rce.install_queue import InstallQueue, dep_set_hash
from app.services.rce.installer import INSTALLED_MARKER_DIR
...
class TestConcurrency:
    async def test_concurrent_identical_misses_run_one_install(self, tmp_path, mocker):
        ...
        mocker.patch(
            "app.services.rce.install_queue.install_packages",
