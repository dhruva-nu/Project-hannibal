...
from app.services.rce.config import SUPPORTED_LANGS
from app.services.rce.deps import DEPS_PROVIDERS, registry_client
...
class PackageSearchService:
    ...
    def verify(self, language: str, name: str) -> PackageVerifyResponse:
        ...
        package = provider.import_to_package.get(name, name)
