...
from app.dependencies.course import LessonServiceDep
...
async def list_blocks(
    lesson_service: LessonBlockServiceDep,
    build_service: BuildBlockServiceDep,
) -> list[BlockItem]:
    try:
...
async def get_lesson_object(
    lesson_id: int,
    lesson_block_service: LessonBlockServiceDep,
